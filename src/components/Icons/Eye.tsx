function Eye({ size }: { size: number }) {
  return (
    <svg viewBox="-0.018 2.957 1.368 1.072" height={size} xmlns="http://www.w3.org/2000/svg">
      <g
        id="_01_align_center"
        data-name="01 align center"
        transform="matrix(0.055556, 0, 0, 0.055556, 0.000121, 2.833333)"
      >
        <path
          fill="currentColor"
        ...
        />
        <path fill="currentColor" d="M12,7a5,5,0,1,0,5,5A5.006,5.006,0,0,0,12,7Zm0,8a3,3,0,1,1,3-3A3,3,0,0,1,12,15Z" />
      </g>
    </svg>
  )
}
